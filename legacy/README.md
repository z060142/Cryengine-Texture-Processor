...
- Processed texture resolution now derives filename suffix stripping from the shared texture type resolver and carries `texture_ref_evidence` into MTL material data
